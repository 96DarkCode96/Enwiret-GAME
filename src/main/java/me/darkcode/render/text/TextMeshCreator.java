...
import me.darkcode.render.text.MetaFile;
...
public class TextMeshCreator {
	...
	protected TextMeshCreator(WindowReference windowReference, File metaFile) {
		metaData = new MetaFile(windowReference, metaFile);
	}
	...
	private List<Line> createStructure(GUIText text) {
		...
		for (char c : chars) {
			...
			Character character = metaData.getCharacter((int) c);
